...
export class StringName extends AbstractName {
    ...
    protected assertCorrectState(name: string): void {
        ...
        MethodFailedException.assertCondition(cond, "StringName not correctly consructed");
    }
    ...
    protected assertCorrectComponent(component: string, index: number) {
        ...
        MethodFailedException.assertCondition(cond, `component is not the same as the one with index ${index}`);
    }
    ...
    private assertValidNoComponents() {
        ...
        InvalidStateException.assertCondition(cond, "noComponents is not equal to the number of components in the name");
    }
